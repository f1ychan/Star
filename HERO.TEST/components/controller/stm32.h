...
typedef struct {
  double Integrator_DSTATE;            /* '<S36>/Integrator' */
  double FilterDifferentiatorTF_states;/* '<S29>/Filter Differentiator TF' */
  double FilterDifferentiatorTF_states_o;/* '<S79>/Filter Differentiator TF' */
  double Integrator_DSTATE_p;          /* '<S86>/Integrator' */
} DW_stm32;

/* External inputs (root inport signals with default storage) */
typedef struct {
  double angle_set;                    /* '<Root>/angle_set' */
  double angle_feedback;               /* '<Root>/angle_feedback' */
  double speed_feedback;               /* '<Root>/speed_feedback' */
  double P_P;                          /* '<Root>/P_P' */
  double P_I;                          /* '<Root>/P_I' */
  double P_D;                          /* '<Root>/P_D' */
  double P_N;                          /* '<Root>/P_N' */
